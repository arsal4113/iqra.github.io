;(function (window) {
  ...
  let texts = ['HAPPY','BIRTHDAY','IQRA','MAY','THIS','BIRTHDAY','ALL','YOUR','WISHES','COME','TRUE','FROM YOUR','ARSLAAN','INSHALLAH YOUR EVERY','WISH, DESIRE, KHUWAISH','WILL COME TRUE','THIS YEAR','AP SBSE ZYAADA','KAMYAB HO INSHALLAH','AP HAIN HUMARA','PROUD AUR INSHALLAH','ESE E RAHAY GI','MAZEED KAMYAB HOTI','HUM HAMESHA APKA','SAATH NIBHAYEGA','CHAHAY KUCH BHI HO','HMESHA PAS PAUGI','I WISH YOU','BEST OF LUCK','MAY THIS YEAR','BRINGS ALOT OF ','HAPPINESS','SUCCESS','HEAVY SHOPPING','HEAVY ENJOYMENT','FOR YOU','STAY SAFE','STAY BLESSED','MY LOVE','I LOVE YOU','....']
